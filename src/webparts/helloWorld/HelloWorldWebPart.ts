...
export default class HelloWorldWebPart extends BaseClientSideWebPart<IHelloWorldWebPartProps> {
  ...
  private createNewItem(): void {
    ...
    const newItemTitle: string = createTitleDom.value;
    const newItemdescription: string = createdescriptionDom.value;
  ...
  private updateItem(): void {
    ...
    const updateItemId: string = updateIdDom.value;
    const updateItemTitle: string = updateTitleDom.value;
    const updateItemDescription: string = updateDescriptionDom.value;
  ...
  private deleteItem(): void {
    ...
    const deleteItemId: string = deleteIdDom.value;
